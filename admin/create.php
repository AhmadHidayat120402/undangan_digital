...
if (isset($_POST['simpan'])) {
  ...
  $query = "INSERT INTO tb_greetings (nama,status_kehadiran,ucapan) VALUES ('$nama_lengkap','$status','$ucapan)";
        ...
        <div class="container-fluid">
          ...
          <form action="" method="POST">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="exampleInputEmail1" name="ucapan">
            </div>
